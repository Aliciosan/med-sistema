...
export default function PatientHome() {
  ...
  // Função para navegar
  const goToBooking = () => navigate('/portal/novo');
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* ... (CARD DE BOAS VINDAS MANTIDO IGUAL) ... */}
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex flex-col justify-center">
          ...
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-center">
            <p className="text-slate-500 text-sm">Acesse seu histórico para ver detalhes.</p>
      ...
      {/* Seção de Serviços - AGORA CLICÁVEIS */}
      <div>
        <h2 className="font-bold text-slate-800 text-xl mb-4">Serviços Disponíveis</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          
          <div onClick={goToBooking} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:border-primary/50 transition-all cursor-pointer group">
