...
import { Home, Calendar, LogOut, PlusCircle, User } from 'lucide-react';
...
export default function PatientLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans pb-24 md:pb-0">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
               ...
               <button onClick={logout} className="p-2 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-lg transition-colors" title="Sair">
                 <LogOut size={20} />
               </button>
            </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 px-6 py-2 flex justify-around items-center z-50 pb-safe shadow-[0_-5px_15px_rgba(0,0,0,0.03)]">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <div className={isActive ? 'transform -translate-y-1' : ''}>
